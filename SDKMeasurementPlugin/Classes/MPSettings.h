 ...
 */
@property (class, nonatomic, assign) MPTestAdType testAdType;
 ...
 */
@property (class, nonatomic, weak, nullable) id<MPLoggingDelegate> loggingDelegate;
...
@protocol MPLoggingDelegate <NSObject>

- (void)logAtLevel:(MPLogLevel)level
