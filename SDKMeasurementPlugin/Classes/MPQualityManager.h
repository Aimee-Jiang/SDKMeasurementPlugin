...
@interface MPQualityManager : NSObject

@property (nonatomic, strong, readonly, nonnull) MPQualityStatistics *statistics;
...
- (nullable instancetype)initWithTargetView:(nonnull UIView *)targetView
                                      rules:(nullable NSArray<MPQualityRule *> *)rules NS_DESIGNATED_INITIALIZER;
